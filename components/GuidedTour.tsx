...
const STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: "🏆 This is the $100K Challenge",
    body: "You start with $100,000 in virtual cash — no real money. Buy and sell real stocks at live prices and try to beat the S&P 500.",
