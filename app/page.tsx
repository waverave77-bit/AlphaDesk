      ...
      <section className="px-6 pb-16 max-w-3xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className={`bg-[#2563eb] text-[#fff] p-7 relative ${sticker}`}>
            ...
            <ul className="space-y-2.5 mb-7">
              {['Everything in Free','Unlimited Mr. Guy chat','Unlimited AI stock breakdowns','No daily limits, ever','A 2nd $100K portfolio','Exclusive colour themes & outfits','A Pro badge on the leaderboard'].map((f) => (
