...
export default function SimIntro() {
  ...
  return (
    <div className="relative overflow-hidden bg-gray-900 bg-gradient-to-br from-blue-500/10 via-transparent to-transparent border-2 border-blue-500/20 rounded-3xl p-5 sm:p-6">
      ...
      <button onClick={dismiss} className="w-full mt-5 bg-blue-600 hover:bg-blue-500 text-[#fff] font-bold rounded-2xl py-3 transition-colors">Let’s go</button>
    </div>
  )
}
